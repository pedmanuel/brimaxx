...
const passwordUpdateForm =()=> ( 
 <form
  ...
  <div className=" form-group">
      ...
      <label    className="  text-dark   form-control mb-3 text-center " style={{ background: "rgba(0, 0, 0, 0.1)",}} > <b>P a s s w o r d </b></label>
    ...
    <div className='form-group col-md-5 mx-auto'>
      <Button
       style={{background:"black",boxShadow: '2px 2px 4px rgba(0, 255, 255, 0.6)'}}
