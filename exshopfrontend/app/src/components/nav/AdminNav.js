...
<nav
 ...
 style={{background:"#26004d",boxShadow: '2px 2px 4px rgba(0, 255, 255, 0.4)'}}
className="mx-auto form-control btn btn-inverse  btn-secondary "
           ...
           <li
             ...
             // style={{background:"#26004d"}} 
               ...
               >
                    ...
                    <Link class="dropdown-item text-dark" to="/admin/product">  P r o d u t o   </Link>
